...
<a href="calzado/create" class="btn btn-warning">Crear</a>
...
<table id="calzado" class="table table-striped table-border shadow-lg mt-4">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <form action="{{route('calzado.destroy', $calzado_->id)}}" method="POST">
                    <a href="/calzado/{{$calzado_->id}}/edit"class="btn btn-danger">Editar</a>
                    @csrf
                    @method('DELETE')
